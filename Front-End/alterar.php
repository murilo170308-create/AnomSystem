...
<head>
    ...
    <link rel="stylesheet" href="../css/styleAlterar.css">
...
<body>
    ...
    <div class="botoes">
        <button type="button" class="btn btn-outline-success" onclick="window.location.href='anomalias.phps'">Salvar</button>
